...
export default function Journal() {
  return (
    <main className="min-h-screen bg-background px-6 pb-20 pt-40 md:px-12">
          ...
          {journalPosts.map((post) => (
            ...
            >
              ...
              <motion.div
                ...
                className="pointer-events-none absolute top-1/2 right-20 h-32 w-64 -translate-y-1/2 rounded-full bg-gradient-to-r from-accent/20 to-transparent opacity-0 blur-2xl group-hover:opacity-100"
              />
            </Link>
          ))}
        </div>
